...
import { LayoutDashboard, Users, Briefcase, DollarSign, FileText, Settings, Activity, LogOut, Menu, X } from "lucide-react";
...
const navItems = [
  ...
  { path: "/admin/staff", label: "Staff", icon: Briefcase },
