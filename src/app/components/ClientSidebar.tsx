...
const navItems = [
  ...
  { path: "/client/tracking", label: "Track Service", icon: MapPin },
  { path: "/client/feedback", label: "Feedback", icon: MessageSquare },
    ...
    <>
      ...
      >
              ...
              <Link
                ...
                className={`flex items-center gap-3 px-4 py-3 rounded-md transition-all duration-200 ${
                  isActive
                    ...
                    : "text-[#fffefe]/70 hover:bg-[#2a2a2a] hover:text-[#fcb316]"
                }`}
        ...
        <div className="p-4 border-t border-[#2a2a2a]">
          <Link
            to="/login"
            className="flex items-center gap-3 px-4 py-3 rounded-md text-[#fffefe]/70 hover:bg-[#2a2a2a] hover:text-red-500 transition-all duration-200"
            style={{ fontFamily: "var(--font-subheading)" }}
          >
